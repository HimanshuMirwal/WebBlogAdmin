...
export default class DisplayRecords extends Component {
    ...
    componentDidMount() {
        Axios.get("https://cors-anywhere.herokuapp.com/https://obscure-lake-21900.herokuapp.com/place/getplace/")
            .then((res) => {
    ...
    OnClickDeleteData(id) {
        Axios.post("https://cors-anywhere.herokuapp.com/https://obscure-lake-21900.herokuapp.com/place/delete/" + id)
            .then(res => {
    ...
    OnClickDeleteDataForSubtitle(value, NameOfSubtitle) {
        Axios.post("https://cors-anywhere.herokuapp.com/https://obscure-lake-21900.herokuapp.com/subtittle/delete/" + value,{NameOfSubtitle:NameOfSubtitle})
            .then(res => {
                console.log(res.data+" Click Refresh Button to see Results.")
                document.getElementById("DisplayRecords").innerHTML=this.state.DivSuccess
            })
    ...
    OnClickSubtitleChangeValue(value){
        ...
        Axios.post("https://cors-anywhere.herokuapp.com/https://obscure-lake-21900.herokuapp.com/subtittle/update/" + value,{SubTitleValue:this.state.SubtitleChangedValue})
            .then((res )=> {
                console.log(res.data+" if not then Click Refresh Button to see Results.")
                this.OnRefreshData();
                Axios.post("https://cors-anywhere.herokuapp.com/https://obscure-lake-21900.herokuapp.com/place/updateSubtitle/" + this.state.SubtitleChangedValue,{DataToSend:data})
