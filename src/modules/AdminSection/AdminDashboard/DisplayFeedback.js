...
export default class DisplayFeedback extends Component {
    ...
    componentDidMount() {
        axios.get("https://cors-anywhere.herokuapp.com/https://obscure-lake-21900.herokuapp.com/feedback/getfeedback")
            .then(res =>
                this.setState({
    ...
    onClickFunction(EmailRecepient, Name, Feedback, index) {
        ...
        if(data > 0){
        axios.post("https://cors-anywhere.herokuapp.com/https://obscure-lake-21900.herokuapp.com/feedback/replyfeedback/", { EmailRecepient: EmailRecepient, message: this.state.ReplyValue, NameOfRecepient: Name,FeedbackMessage:Feedback })
            .then(res => {
    ...
    OnDeleteFeedback(id) {
        axios.post("https://cors-anywhere.herokuapp.com/https://obscure-lake-21900.herokuapp.com/feedback/deletefeedback/" + id)
            .then(res => {
                console.log(res.data)
                axios.get("https://cors-anywhere.herokuapp.com/https://obscure-lake-21900.herokuapp.com/feedback/getfeedback")
                    .then(res =>
