...
export default class DisplayFeedback extends Component {
    ...
    onClickFunction(EmailRecepient, Name, Feedback, index) {
        ...
        if(data > 0){
        axios.post("feedback/replyfeedback/", { EmailRecepient: EmailRecepient, message: this.state.ReplyValue, NameOfRecepient: Name,FeedbackMessage:Feedback })
            .then(res => {
    ...
    OnDeleteFeedback(id) {
        axios.post("feedback/deletefeedback/" + id)
            .then(res => {
                console.log(res.data)
                axios.get("feedback/getfeedback")
                    .then(res =>
